...
pub fn build(b: *std.Build) void {
    ...
    const protoc_step = protobuf.RunProtocStep.create(protobuf_dep.builder, target, .{
        ...
        .source_files = &.{ "proto/gradido/basic_types.proto", "proto/gradido/confirmed_transaction.proto", "proto/gradido/transaction_body.proto" },
        .include_directories = &.{
            "gradido_protocol",
        },
    });
    ...
    //const mod = b.addModule("gradido_protobuf_zig", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            // .imports = &.{
            // Here "gradido_protobuf_zig" is the name you will use in your source code to
            // import this module (e.g. `@import("gradido_protobuf_zig")`). The name is
